...
| [claude-code/](claude-code/README.md) | Settings của Claude Code: sandbox bắt buộc, allowlist mạng chặt, chặn đọc ngoài thư mục làm việc cho cả tool file built-in, tắt chế độ bỏ phê duyệt | ISO-02, ISO-03, NET-01, NET-02, ACT-03, SC-02 | Claude Code 2.1.273 trên macOS |
